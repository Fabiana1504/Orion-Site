      ...
      <div className="container">
        ...
        >
          ...
          <p className="section-lead section-lead-interactive">
            ...
            <Link href="/equipo/laboratorio">
              laboratory
            </Link>{" "}
            (sign-in required). Below that, you can access{" "}
            <Link href="/herramientas-equipos">the public tools draft for other teams</Link> (no password).
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="analytics-gate">
            ...
            <div className="analytics-gate-actions">
              <Link href="/herramientas-equipos" className="btn btn-ghost analytics-sketch-btn">
                Team tools
              </Link>
              <Link
